import{a as e}from"./chunk-JKPGA2EE.js";import"./chunk-FW4363Y4.js";var $=[{label:"A",text:"1"},{label:"B",text:"2"},{label:"C",text:"3"},{label:"D",text:"4"},{label:"E",text:"5"}],s={1:{id:"A3-q1",text:"In a certain group of students, each student studies at least one of three instruments: A, B, or C, or studies none of them. If $\\frac{1}{4}$ of the students study instrument A exclusively, $\\frac{1}{6}$ of the students study instrument B exclusively, and $\\frac{1}{8}$ of the students study instrument C exclusively, and the remaining \\$143$ students do not study any of the three instruments, how many more students study instrument B exclusively than study instrument C exclusively?",options:[{label:"A",text:"11"},{label:"B",text:"13"},{label:"C",text:"15"},{label:"D",text:"17"},{label:"E",text:"19"}],correctAnswer:"B",explanation:`Let $T$ be the total number of students in the group.
    ...
    Thus, the correct answer is B.`},2:{id:"A3-q2",text:"If \\$2^{-2x} - 2 \\times 2^{-x} - 3 = 0$, then \\$2^{-x} = ?$",options:$,correctAnswer:"C",explanation:`The given equation is \\$2^{-2x} - 2 \\times 2^{-x} - 3 = 0$.
      ...
      *   \\$2 \\times 2^{-x} = 2 \\times 2^{-x}$
      ...
      Thus, the correct answer is C.`},3:{id:"A3-q3",text:"If $x=\\sqrt{3}-\\sqrt{7}$, then $(\\frac{x}{2})+(\\frac{2}{x})=?$",options:[{label:"A",text:"$\\sqrt{3}$"},{label:"B",text:"$\\sqrt{7}$"},{label:"C",text:"$-\\sqrt{3}$"},{label:"D",text:"$-\\sqrt{7}$"},{label:"E",text:"$-\\sqrt{10}$"}],correctAnswer:"D",explanation:`Given $x = \\sqrt{3} - \\sqrt{7}$.
      ...
      Thus, the correct answer is D.`},4:{id:"A3-q4",text:"What is the value of $m-n$=?",statements:["$m=n^2-1$","$n=m^2-1$"],options:e,correctAnswer:"E",explanation:`We need to find the value of $m - n$.
      ...
      *   If $n = -1: (-1)^3 - 2(-1) - 1 = -1 + 2 - 1 = 0$. So $n = -1$ is a solution.
      ...
      Thus, the correct answer is E.`},5:{id:"A3-q5",text:"Is $|x-y|>||x|-|y||$?",statements:["$xy<0$","$x>y$"],options:e,correctAnswer:"A",explanation:`We want to determine if $|x-y| > ||x|-|y||$.
      ...
      *   Case 3: $x=-1, y=-2$. Then $xy > 0$. The inequality does NOT hold: $|-1 - (-2)| = |1| = 1$. $||-1|-|-2|| = |1-2| = |-1| = 1$. \\$1$ is not $> 1$.
      ...
      Thus, the correct answer is A.`},6:{id:"A3-q6",text:"A certain worker is paid at a rate of \\$52.50 per hour for the first \\$8$ hours of work in a day. For any hours worked in excess of \\$8$ hours in a day, the worker is paid at a rate of \\$65.00$ per hour. How many hours did the worker work yesterday?",statements:["If the worker had worked \\$4$ more hours yesterday, the worker's total earnings for the day would have increased by \\$260$.","The worker's total earnings for yesterday were \\$550$."],options:e,correctAnswer:"B",explanation:`Let $H$ be the total number of hours the worker worked yesterday.
      ...
      *   If $H > 8$, earnings = \\$8 \\times 52.50 + (H - 8) \\times 65.00$.
      ...
      Thus, the correct answer is B.`},7:{id:"A3-q7",text:"What is the sum of the remainders when each of the first \\$50$ positive integers is divided by \\$6$?",options:[{label:"A",text:"115"},{label:"B",text:"120"},{label:"C",text:"123"},{label:"D",text:"125"},{label:"E",text:"128"}],correctAnswer:"C",explanation:`When a positive integer is divided by \\$6$, the possible remainders are \\$0, 1, 2, 3, 4, 5$.
      ...
      *   \\$50 \\div 6 = 8$ R \\$2$
      ...
      Thus, the correct answer is C.`},8:{id:"A3-q8",text:"The value of \\$3^{13} \\times 33^{11}$ is closest to which of the following?",options:[{label:"A",text:"\\$10^{20}$"},{label:"B",text:"\\$10^{21}$"},{label:"C",text:"\\$10^{22}$"},{label:"D",text:"\\$10^{23}$"},{label:"E",text:"\\$10^{24}$"}],correctAnswer:"D",explanation:`We need to find the value of \\$3^{13} \\times 33^{11}$.
      ...
      **Multiplying the approximations:**
      ...
      Thus, the correct answer is D.`},9:{id:"A3-q9",text:"If $x, y,$ and $z$ are three distinct integers, does $y$ lie between $x$ and $z$ on the number line? <br/>* $\\min(A, B)$ means the smaller value between $A$ and $B$. For example, $\\min(5, 3) = 3$.<br/>* $\\max(A, B)$ means the larger value between $A$ and $B$. For example, $\\max(5, 3) = 5$.",statements:["$y$ is the minimum value of the set {max(x, y), max(y, z), max(z, x)}.","$y$ is the maximum value of the set {min(x, y), min(y, z), min(z, x)}."],options:e,correctAnswer:"D",explanation:`We are given that $x, y,$ and $z$ are three distinct integers.
      ...
      *   Case F: $z < x < y$.
      ...
      Since EACH statement ALONE is sufficient, the correct answer is D.`},10:{id:"A3-q10",text:"Let $a, b, c,$ and $d$ be distinct non-zero digits. What is the value of the product $(a+d)(b+c)$?",statements:['The sum of the four-digit integer "$\\mathbf{abcd}$" and the four-digit integer "$\\mathbf{dcba}$" is \\$7,557$. (Where "$\\mathbf{abcd}$" represents the value \\$1,000a + 100b + 10c + d$).','The sum of the four-digit integer "$\\mathbf{abcd}$" and the three-digit integer "$\\mathbf{dba}$" is \\$1,957$.'],options:e,correctAnswer:"D",explanation:`We are given that $a, b, c,$ and $d$ are distinct non-zero digits (i.e., from \\$1$ to \\$9$).
      ...
      *   If $b=3, 33+c=35 \\Rightarrow c=2$.
      ...
      Since EACH statement ALONE is sufficient, the correct answer is D.`},11:{id:"A3-q11",text:"At least \\$100$ students at a certain high school study Japanese. If \\$4\\%$ of the students at the school who study French also study Japanese, do more students at the school study French than Japanese?",statements:["\\$16$ students at the school who study both French and Japanese","\\$10\\%$ of the students at the school who study Japanese also study French."],options:e,correctAnswer:"B",explanation:`Let $J$ be the number of students who study Japanese.
          ...
          **Statement (2):** \\$10\\%$ of the students at the school who study Japanese also study French.
          ...
          Thus, the correct answer is B.`},12:{id:"A3-q12",text:"Is $a > c$?",statements:["$b > d$","$ab^2 - b > b^2c - d$"],options:e,correctAnswer:"C",explanation:`We need to determine if $a > c$. Assume $a, b, c, d$ are real numbers.
      ...
      **Combining Statement (1) and Statement (2):**
      ...
      Thus, the correct answer is C.`}};export{s as EXAM_A3_QUESTIONS};
//# sourceMappingURL=A3-DRUQK74B.js.map
