...
export const PS_ROMAN_NUMERALS_OPTIONS: Option[] = [
  { label: "A", text: "I. only" },
  { label: "B", text: "I. & II. only" },
  { label: "C", text: "II. & III. only" },
  { label: "D", text: "All of the above" }, 
  { label: "E", text: "None of the above" }
];

export const EXAM_A1_QUESTIONS: Record<number, Question> = {
  1: {
    id: 'A1-q1',
  ...
  5: {
    ...
    options: DS_OPTIONS,
    correctAnswer: 'A',
    explanation: `Let $P(H)$ be the probability of landing heads on a single toss, and $P(T)$ be the probability of landing tails on a single toss. We know $P(T) = 1 - P(H)$.
      ...
      **Statement (2):** The probability of landing exactly one head in two tosses is $\\frac{4}{9}$.
      ...
      If $P(H) = \\frac{2}{3}$, then $P(H)^2 = (\\frac{2}{3})^2 = \\frac{4}{9}$.
  ...
  7: {
    id: 'A1-q7',
    text: 'If $a^2-b^2=-21$, what is the value of $a^4-b^4$?',
    statements: [
      '$a+b=-3$',
      '$a-b=7$'
    ],
    options: DS_OPTIONS,
    correctAnswer: 'D',
    explanation: `We are given $a^2 - b^2 = -21$. We want to find the value of $a^4 - b^4$.
  ...
  10: {
    id: 'A1-q10',
    text: '$(2.5^2 - 1.5^2)+(4.5^2 - 3.5^2)+(6.5^2 - 5.5^2)+\\dots+(100.5^2-99.5^2)=?$',
    options: [ 
      { label: "A", text: "2550" },
      { label: "B", text: "3100" },
      { label: "C", text: "5100" },
    ...
    correctAnswer: 'C',
    explanation: `The expression is a sum of terms in the form $(N.5^2 - (N-1).5^2)$.
  ...
  12: {
    id: 'A1-q12',
    text: 'If $(x^2-5x-1)^2-25=(x-a) \\times (x-b) \\times (x-c) \\times (x-d)$, then $a \\times b \\times c \\times d = ?$',
    options: [ 
      { label: "A", text: "-30" },
      { label: "B", text: "-24" },
      { label: "C", text: "-12" },
    ...
    correctAnswer: 'B',
    explanation: `The given equation is $(x^2 - 5x - 1)^2 - 25 = (x - a)(x - b)(x - c)(x - d)$.
