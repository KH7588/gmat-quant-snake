...
export const EXAM_A7_QUESTIONS: Record<number, Question> = {
  1: {
    id: 'A7-q1',
    text: 'If r and s are positive integers, is (r-s) divisible by 3?',
    statements: [
      'rs is divisible by 9',
      's is divisible by 3'
    ],
    options: DS_OPTIONS,
    correctAnswer: 'E',
    explanation: `The question asks if (r-s) is a multiple of 3.
...
Thus, the correct answer is E.`
  ...
  2: {
    id: 'A7-q2',
    text: 'From a group consisting of 5 Spaniards, 4 Germans, and 3 Frenchmen, a team is to be formed that includes exactly one Spaniard, one German, and one Frenchman. How many distinct teams can be formed?',
    options: [
        { label: "A", text: "12" },
        { label: "B", text: "60" },
        { label: "C", text: "120" },
...
Thus, there are 360 distinct teams that can be formed.`
  ...
  3: {
    id: 'A7-q3',
    text: 'A set consists of five positive integers. The arithmetic mean of the five integers is 10, the median is 12, and the mode is 15. Which of the following integers could be members of the set?',
    romanNumerals: {
      I: '1',
      II: '9',
      III: '13'
...
Thus, the correct answer is A.`
  ...
  4: {
    id: 'A7-q4',
    text: 'In a certain company, the ratio of the number of men to the number of women is 3 to 5. The employees are divided into two groups, A and B, having an equal number of employees. If the ratio of men to women in Group A is 5 to 7, what is the ratio of men to women in Group B?',
    options: [
        { label: "A", text: "1:1" },
        { label: "B", text: "1:2" },
        { label: "C", text: "2:3" },
    ...
    correctAnswer: 'B',
    explanation: `Let the total number of employees be a number divisible by the denominators of the ratios to avoid fractions.
...
Thus, the correct answer is B.`
  ...
  5: {
    id: 'A7-q5',
    text: 'In sequence $S$, the first two terms are $S_1 = S_2 = 3$, and the recursive formula is $S_n = \\left(\\frac{S_{n-1}}{S_{n-2}}\\right)^2$. What is the value of $S_6$?',
    options: [
        { label: "A", text: "1" },
        { label: "B", text: "$\\frac{1}{3}$" },
        { label: "C", text: "$\\frac{1}{9}$" },
        { label: "D", text: "$\\frac{1}{27}$" },
        { label: "E", text: "$\\frac{1}{81}$" }
    ],
    correctAnswer: 'E',
    explanation: `We are given the sequence definition:
$S_1 = 3$
$S_2 = 3$
...
Thus, the correct answer is E.`
  ...
  6: {
    ...
    options: DS_OPTIONS,
    correctAnswer: 'B',
    explanation: `The question asks if s and t have opposite signs.
...
Thus, the correct answer is B.`
  ...
  7: {
    id: 'A7-q7',
    text: 'Three identical machines, working together at their respective constant rates, can complete a certain job in 120 minutes. How many of these machines are required to complete two such jobs in 80 minutes?',
    options: [
        { label: "A", text: "6" },
        { label: "B", text: "8" },
        { label: "C", text: "9" },
    ...
    correctAnswer: 'C',
    explanation: `Let R be the rate of one machine (in jobs per minute).
...
2.  **Calculate the number of machines needed for the new task:**
  ...
  8: {
    id: 'A7-q8',
    text: 'Person A traveled a distance of 80 miles at an average speed of x miles per hour, taking (y-3) hours to complete the trip. Person B traveled the same distance of 80 miles at an average speed of (x-4) miles per hour, taking (y-2) hours to complete the trip. What is the ratio of A\'s average speed to B\'s average speed?',
    options: [
        { label: "A", text: "4:3" },
        { label: "B", text: "3:2" },
        { label: "C", text: "5:3" },
...
Thus, the correct answer is D.`
  ...
  9: {
    id: 'A7-q9',
    text: 'Of a total shipment of porcelain pieces, $\\frac{1}{3}$ were chipped, $\\frac{2}{3}$ were cracked, and $\\frac{1}{6}$ were both chipped and cracked. If 150 pieces were neither chipped nor cracked, what was the total number of pieces in the shipment?',
    options: [
        { label: "A", text: "300" },
        { label: "B", text: "450" },
        { label: "C", text: "600" },
    ...
    correctAnswer: 'E',
    explanation: `Let T be the total number of pieces in the shipment.
...
Thus, the correct answer is E.`
  ...
  10: {
    id: 'A7-q10',
    text: 'How many tons of a 10% salt solution must be added to 300 tons of a 15% salt solution to create a resulting solution that is 12% salt by weight?',
    options: [
        { label: "A", text: "150" },
        { label: "B", text: "300" },
        { label: "C", text: "450" },
    ...
    correctAnswer: 'C',
    explanation: `Let x be the number of tons of the 10% salt solution to be added.
...
Thus, the correct answer is C.`
  ...
  11: {
    id: 'A7-q11',
    text: 'How many distinct real solutions does the equation $x^4 - 2x^3 + x^2 = 0$ have?',
    options: [
        { label: "A", text: "0" },
        { label: "B", text: "1" },
        { label: "C", text: "2" },
    ...
    correctAnswer: 'C',
    explanation: `The given equation is $x^4 - 2x^3 + x^2 = 0$.
...
Thus, the correct answer is C.`
  ...
  12: {
    id: 'A7-q12',
    text: 'A taxi fare consists of a base charge of \\$6.00, a distance charge of \\$0.90 for each 0.2 kilometers traveled, and a waiting charge of \\$0.60 per minute spent stopped in traffic. If a certain 5-kilometer trip took a total of 20 minutes, during which 30 percent of the time was spent stopped in traffic, what was the total fare for the trip?',
    options: [
        { label: "A", text: "\\$29.10" },
        { label: "B", text: "\\$31.50" },
        { label: "C", text: "\\$32.10" },
    ...
    correctAnswer: 'C',
    explanation: `Let's break down the total fare into its three components: base charge, distance charge, and waiting charge.
