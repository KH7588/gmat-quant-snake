import{a as e}from"./chunk-JKPGA2EE.js";import"./chunk-FW4363Y4.js";var t=[{label:"A",text:"6"},{label:"B",text:"9"},{label:"C",text:"12"},{label:"D",text:"15"},{label:"E",text:"18"}],$=[{label:"A",text:"2"},{label:"B",text:"4"},{label:"C",text:"8"},{label:"D",text:"16"},{label:"E",text:"32"}],a=[{label:"A",text:"$\\frac{1}{6}$"},{label:"B",text:"$\\frac{1}{4}$"},{label:"C",text:"$\\frac{5}{18}$"},{label:"D",text:"$\\frac{1}{3}$"},{label:"E",text:"$\\frac{7}{18}$"}],o=[{label:"A",text:"$x$"},{label:"B",text:"$x+1$"},{label:"C",text:"\\$2x+1$"},{label:"D",text:"\\$3x+1$"},{label:"E",text:"\\$2x+2$"}],i=[{label:"A",text:"0"},{label:"B",text:"1"},{label:"C",text:"2"},{label:"D",text:"3"},{label:"E",text:"4"}],n=[{label:"A",text:"1"},{label:"B",text:"3"},{label:"C",text:"4"},{label:"D",text:"6"},{label:"E",text:"8"}],s={1:{id:"A4-q1",text:"If $n$ and $r$ are positive integers such that $n$ is divisible by \\$10^r$ but is not divisible by \\$10^{r+1}$, what is the value of $r$?",statements:["$n$ is divisible by \\$2^5$ but is not divisible by \\$2^6$.","$n$ is divisible by \\$5^6$ but is not divisible by \\$5^7$."],options:e,correctAnswer:"C",explanation:`The question asks for the number of trailing zeros in the integer $n$. The number of trailing zeros is determined by the highest power of \\$10$ that divides $n$. Since \\$10 = 2 \\times 5$, the number of trailing zeros, $r$, is the minimum of the powers of \\$2$ and \\$5$ in the prime factorization of $n$.
    ...
    **Combining Statement (1) and Statement (2):**
    ...
    Thus, the correct answer is C.`},2:{id:"A4-q2",text:'A certain machine performs an operation that rearranges the order of the letters in the input string "ABCDEFG" according to a fixed rule, resulting in the output string "DABCGEF". If the machine repeatedly performs this same operation on the output of the previous operation, starting with the initial input "ABCDEFG", what is the minimum number of operations required until the output string is "ABCDEFG" again?',options:t,correctAnswer:"C",explanation:`Let's analyze the permutation performed by the machine. We can track the position of each letter:
      ...
      *   G (from position 7) moves to position 6.
      ...
      The correct answer is C.`},3:{id:"A4-q3",text:"If $a=x+\\frac{1}{x}$, $b=x-\\frac{1}{x}$, then $\\frac{2^{a^2}}{2^{b^2}}=?$",options:$,correctAnswer:"D",explanation:`Given:
      $a = x + \\frac{1}{x}$
      $b = x - \\frac{1}{x}$
      ...
      **Step 4: Sum the probabilities of these events.**
      ...
      The correct answer is C.`},5:{id:"A4-q5",text:"Players A, B, and C take turns playing a card game, individually and in the fixed order A, B, C, A, B, C, and so on. If no other players participated, how many rounds did player C play?",statements:["Player A played the first round and the last round.","Player B played exactly \\$17$ rounds."],options:e,correctAnswer:"C",explanation:`Let $N$ be the total number of rounds played.
      ...
      *   Player C: $N_C = k = 17$ rounds.
      ...
      Thus, the correct answer is C.`},6:{id:"A4-q6",text:"If $x^2=x+1$, then $x^3=?$",options:o,correctAnswer:"C",explanation:`We are given the equation: $x^2 = x+1$.
      ...
      Thus, the correct answer is C.`},7:{id:"A4-q7",text:"Is $|a-b-c|-(a-b-c)>0$?",statements:["$a>b>c$","$a>0, b>0, c>0$"],options:e,correctAnswer:"E",explanation:`Let $X = a-b-c$.
      ...
      *   We also found an example from Statement (1) where $a-b-c < 0$ ($a=4, b=3, c=2$). Here, $a-b-c$ is $< 0$. (Yes)
      ...
      Thus, the correct answer is E.`},8:{id:"A4-q8",text:"For a sequence defined by $S_n$, $S_1=1, S_2=2, S_3=3$, and $S_{n+3}=S_n-S_{n+1}+S_{n+2}$ for all integers $n \\ge 1$. What is the value of $S_{10}$?",options:i,correctAnswer:"C",explanation:`We are given the first three terms of a sequence and a recursive formula:
      $S_1 = 1$
      $S_2 = 2$
      $S_3 = 3$
      ...
      *   If $n \\pmod 4 = 0, S_n = 2$
      ...
      Thus, the correct answer is C.`},9:{id:"A4-q9",text:"If $a, b, c, d, e, f,$ and $g$ are \\$7$ prime numbers, what is the value of $a$?",statements:["The mean of the \\$7$ prime numbers is \\$48$.","$a < b < c < d < e < f < g$"],options:e,correctAnswer:"C",explanation:`We are given that $a, b, c, d, e, f,$ and $g$ are \\$7$ prime numbers. We need to find the value of $a$.
      ...
      **Combining Statement (1) and Statement (2):**
      ...
      Thus, the correct answer is C.`},10:{id:"A4-q10",text:"A driver traveled a total distance of \\$85$ miles in \\$1$ hour and \\$24$ minutes. The driver traveled at a constant speed of $x$ miles per hour through a construction zone and at a constant speed of $y$ miles per hour through the remainder of the trip. What is the value of $y$?",statements:["$y = 2x$","The distance traveled through the construction zone was \\$5$ miles."],options:e,correctAnswer:"C",explanation:`Let $D$ be the total distance and $T$ be the total time.
      $D = 85$ miles.
      ...
      **Combining Statement (1) and Statement (2):**
      ...
      Thus, the correct answer is C.`},11:{id:"A4-q11",text:"If $||x-a|-b|=c$, what is the sum of all possible values of $x$?",statements:["$a-b-c=2$","$a+b+c=2$"],options:e,correctAnswer:"C",explanation:`The equation is $||x-a|-b|=c$. We want to find the sum of all possible values of $x$.
      ...
      *   **Case B: If $c > 0$**
      ...
      Thus, the correct answer is C.`},12:{id:"A4-q12",text:"Bag A contains red, white and blue marbles such that the red to white marble ratio is \\$1:3$ and the white to blue marble ratio is \\$2:3$. Bag B contains red and white marbles in the ratio of \\$1:4$. Together, the two bags contain \\$30$ white marbles. How many red marbles could be in bag A?",options:n,correctAnswer:"D",explanation:`**1. Analyze Bag A Ratios:**
      Red : White = \\$1 : 3$
      White : Blue = \\$2 : 3$
      ...
      *   If $k = 3$, Red marbles in Bag A = \\$2(3) = 6$.
      ...
      Thus, the correct answer is D.`}};export{s as EXAM_A4_QUESTIONS};
//# sourceMappingURL=A4-6AFVVAM5.js.map
