import{a as e}from"./chunk-JKPGA2EE.js";import"./chunk-FW4363Y4.js";var t=[{label:"A",text:"0"},{label:"B",text:"1"},{label:"C",text:"2"},{label:"D",text:"3"},{label:"E",text:"4"}],$=[{label:"A",text:"1"},{label:"B",text:"2"},{label:"C",text:"3"},{label:"D",text:"4"},{label:"E",text:"5"}],n={1:{id:"A5-q1",text:"If $d_1, d_2, d_3, d_4$ are distinct digits, is the sum of the decimals \\$0.d_1d_2$ and \\$0.d_3d_4$ greater than \\$1$?",statements:["The least of these four digits is \\$4$.","$(0.d_1d_2) \\times (0.d_3d_4) > \\frac{1}{2}$"],options:e,correctAnswer:"D",explanation:`We want to determine if $(0.d_1d_2) + (0.d_3d_4) > 1$.
...
Thus, the correct answer is D.`},2:{id:"A5-q2",text:"If $n$ is a positive integer, what is the remainder when \\$3^{8n+3}+2$ is divided by \\$5$?",options:t,correctAnswer:"E",explanation:`We need to find the remainder of $(3^{8n+3} + 2)$ divided by \\$5$.
...
The correct answer is E (4).`},3:{id:"A5-q3",text:"If $n$ is a positive integer and $x = \\frac{(2n-1)!}{n!(n-1)!}$, is $x$ odd?",statements:["$n \\in \\{3, 4, 8\\}$ ($n$ is one of \\$3, 4,$ or \\$8$)","$n \\in \\{4, 5, 8\\}$ ($n$ is one of \\$4, 5,$ or \\$8$)"],options:e,correctAnswer:"C",explanation:`Let's calculate $x$ for specific values of $n$.
...
Thus, the correct answer is C.`},4:{id:"A5-q4",text:"If $x$ is a nonnegative integer, and $f(x)=x+ \\sqrt{x}$. Given $z=y^2$, is $f(z)=y^2+y$?",statements:["$y>0$","$z>0$"],options:e,correctAnswer:"A",explanation:`We are given $f(x) = x + \\sqrt{x}$ and $z = y^2$.
...
Thus, the correct answer is A.`},5:{id:"A5-q5",text:"What are the values of $x$ and $y$?",statements:["$(x-2)^2+(y-1)=0$","$(x-2)^2+|y-1|=0$"],options:e,correctAnswer:"B",explanation:`**Statement (1):** $(x-2)^2 + (y-1) = 0$.
$(x-2)^2 = -(y-1) = 1-y$.
...
Thus, the correct answer is B.`},6:{id:"A5-q6",text:"For a sequence $S$, the $n$th term is defined by $\\frac{1}{s_n} = 2 \\left( \\frac{1}{n} - \\frac{1}{n+1} \\right)$. What is the value of $\\frac{1}{s_1} + \\frac{1}{s_2} + \\frac{1}{s_3} + \\dots + \\frac{1}{s_{99}}$?",options:[{label:"A",text:"1"},{label:"B",text:"1.5"},{label:"C",text:"$\\frac{99}{50}$"},{label:"D",text:"2"},{label:"E",text:"$\\frac{101}{50}$"}],correctAnswer:"C",explanation:`We want to calculate the sum $\\sum_{n=1}^{99} \\frac{1}{s_n}$.
...
Thus, the correct answer is C.`},7:{id:"A5-q7",text:"If $n \\neq 0$, $n \\neq -1$, and $\\frac{1}{n+1} > \\frac{1}{n}$, which of the following must be true?",options:[{label:"A",text:"$-2 < n < -1$"},{label:"B",text:"$-1 < n < 0$"},{label:"C",text:"\\$0 < n < 1$"},{label:"D",text:"\\$1 < n < 2$"},{label:"E",text:"$n > 2$"}],correctAnswer:"B",explanation:`We are given $\\frac{1}{n+1} > \\frac{1}{n}$.
...
Thus, the correct answer is B.`},8:{id:"A5-q8",text:"How many distinct real solutions does the equation $(x-5)^2(x+5)^2=(x+5)^2$ have?",options:$,correctAnswer:"C",explanation:`Given: $(x-5)^2(x+5)^2 = (x+5)^2$.
...
Thus, the correct answer is C.`},9:{id:"A5-q9",text:"Two distinct numbers, $p$ and $q$, are selected from the set $\\{3, 4, 5, 8, 9\\}$ to form an ordered pair $(p, q)$. If $p=a-b$ and $q=a+b$ for some positive integers $a$ and $b$, how many such ordered pairs are possible?",options:$,correctAnswer:"D",explanation:`We have $p = a-b$ and $q = a+b$.
...
Thus, the correct answer is D.`},10:{id:"A5-q10",text:"Mixture 1 contains only peanuts and cashews, such that $\\frac{3}{4}$ of the nuts are peanuts. Mixture 2 contains exactly \\$8$ fewer peanuts than Mixture 1 and the same number of cashews as Mixture 1. If peanuts constitute $\\frac{7}{10}$ of the total nuts in Mixture 2, what is the total number of nuts in Mixture 1?",options:[{label:"A",text:"40"},{label:"B",text:"44"},{label:"C",text:"48"},{label:"D",text:"52"},{label:"E",text:"56"}],correctAnswer:"C",explanation:`Let $T_1$ be the total nuts in Mixture 1.
...
Thus, the correct answer is C.`},11:{id:"A5-q11",text:"If $|2x+7|<9$, what is the value of $x$?",statements:["$x$ is an integer","$x$ is a nonnegative number"],options:e,correctAnswer:"C",explanation:`First, solve the inequality $|2x+7|<9$.
$-9 < 2x+7 < 9$.
...
Thus, the correct answer is C.`},12:{id:"A5-q12",text:"A restaurant pays a seafood distributor $d$ dollars for \\$6$ pounds of Maine lobster. Each pound can make $v$ vats of lobster bisque, and each vat makes $b$ bowls of lobster bisque. If the cost of the lobster per bowl is an integer, and if $v$ and $b$ are different prime integers, then which of the following is the smallest possible value of $d$?",options:[{label:"A",text:"15"},{label:"B",text:"24"},{label:"C",text:"36"},{label:"D",text:"54"},{label:"E",text:"90"}],correctAnswer:"C",explanation:`Total pounds = 6.
Total vats = \\$6 \\times v$.
...
Thus, the correct answer is C.`}};export{n as EXAM_A5_QUESTIONS};
//# sourceMappingURL=A5-QU6E2QKK.js.map
