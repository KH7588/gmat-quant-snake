import{a as e}from"./chunk-JKPGA2EE.js";import"./chunk-FW4363Y4.js";var a={1:{id:"A6-q1",text:"A list consists of n positive integers. If the sum of these n integers is s, is at least one integer in the list odd?",statements:["The quotient $\\frac{s}{n}$ is an odd integer","The product ns is an even integer"],options:e,correctAnswer:"E",explanation:`The question asks if at least one integer is odd, which is equivalent to asking if the integers are NOT all even.
...
Thus, the correct answer is E.`},2:{id:"A6-q2",text:"The greatest common divisor of the positive integers x and y is d. If 1 < d < x and 1 < d < y, for which of the following pairs of integers must the greatest common divisor equal d?",romanNumerals:{I:"x and 1",II:"xy and y",III:"(x - y) and y"},options:[{label:"A",text:"I only"},{label:"B",text:"II only"},{label:"C",text:"III only"},{label:"D",text:"I and II only"},{label:"E",text:"II and III only"}],correctAnswer:"C",explanation:`We are given that gcd(x, y) = d. This means we can write x = da and y = db, where a and b are integers and gcd(a, b) = 1.
...
Thus, the correct answer is C.`},3:{id:"A6-q3",text:"Is the arithmetic mean of the five numbers a, b, c, d, and e greater than the median of these five numbers?",statements:["a < b < c < d < e","b-a=e-d"],options:e,correctAnswer:"E",explanation:`The question asks if (a+b+c+d+e)/5 > Median.
...
Thus, the correct answer is E.`},4:{id:"A6-q4",text:"How many distinct arrangements of the five letters in the set {b, e, g, i, n} begin with a vowel (e or i)?",options:[{label:"A",text:"24"},{label:"B",text:"48"},{label:"C",text:"72"},{label:"D",text:"96"},{label:"E",text:"120"}],correctAnswer:"B",explanation:`The set of letters is {b, e, g, i, n}. The letters are all distinct.
...
Total arrangements = 2 \xD7 4 \xD7 3 \xD7 2 \xD7 1 = 2 \xD7 4!
Total arrangements = 2 \xD7 24 = 48.

Thus, there are 48 distinct arrangements. The correct option text is 48.

The correct answer is B.`},5:{id:"A6-q5",text:"A box contains exactly 10 balls, numbered 1 through 5 distinctively. Five of the balls are white and numbered 1 through 5, and the other five balls are green and numbered 1 through 5. Two balls are selected at random from the box without replacement. If it is known that one selected ball is white, the other is green, and both carry even numbers, can the specific number on the selected green ball be determined?",statements:["If one ball were selected at random from the remaining 8 balls in the box, the probability that it is a green ball with an even number would be $\\frac{1}{8}$.","If one ball were selected at random from the remaining 8 balls in the box, the probability that it is a ball numbered with a 4 would be $\\frac{1}{4}$."],options:e,correctAnswer:"B",explanation:`Initial state: White balls {W1, W2, W3, W4, W5}, Green balls {G1, G2, G3, G4, G5}.
...
Thus, the correct answer is B.`},6:{id:"A6-q6",text:"At a certain party, the following restrictions apply: A and B will not both attend; B and C will not both attend; and E and F will not both attend. Furthermore, if E attends, then A will attend. Will B attend the party?",statements:["E attends the party.","A and C are good friends and will both attend the party."],options:e,correctAnswer:"D",explanation:`Let's formalize the rules:
...
Since EACH statement ALONE is sufficient, the correct answer is D.`},7:{id:"A6-q7",text:"A customer purchased carpeting to cover a rectangular room with length $a$ and width b. To ensure sufficient coverage, the customer purchased a total area of carpeting equal to the area of the room plus an additional x percent of the room's area. If a sales tax of r percent was added to the pre-tax price of the carpeting, resulting in a final total price of p, what was the pre-tax price per unit area of the carpeting in terms of a, b, x, p, and r?",options:[{label:"A",text:"$\\frac{p(1+r/100)}{ab(1+x/100)}$"},{label:"B",text:"$\\frac{p}{ab(1+x)(1+r)}$"},{label:"C",text:"$\\frac{p}{ab(1+x/100)(1+r/100)}$"},{label:"D",text:"$\\frac{10000p}{ab(100+x)(100+r)}$"},{label:"E",text:"$\\frac{p}{ab(1+x+r)}$"}],correctAnswer:"C",explanation:`Let \\$C be the pre-tax price per unit area.
...
4.  Total pre-tax price = (Price per unit area) \xD7 (Total area purchased) = $\\C \\times ab(1 + \\frac{x}{100})$.
5.  Final total price (p) = (Total pre-tax price) \xD7 (1 + tax rate) = $\\C \\times ab(1 + \\frac{x}{100}) \\times (1 + \\frac{r}{100})$.
6.  Now, solve for \\$C:
...
Thus, the correct answer is C.`},8:{id:"A6-q8",text:"If $x>y, x+y^2=27$, and $x+y=7$, what is the value of $x^2+y$?",options:[{label:"A",text:"-4"},{label:"B",text:"27"},{label:"C",text:"117"},{label:"D",text:"121"},{label:"E",text:"125"}],correctAnswer:"C",explanation:`We have a system of two equations:
1) $x + y^2 = 27$
2) $x + y = 7$
...
Thus, the correct answer is C.`},9:{id:"A6-q9",text:"A total of 10,890 balls are to be placed into baskets on a conveyor belt. There are six distinct types of baskets arranged in a repeating sequence: P, Q, R, S, T, U, P, Q, ... Each basket is filled with exactly 6 balls before the machine moves to the next basket type in the sequence. Into which type of basket will the very last ball be placed?",options:[{label:"A",text:"P"},{label:"B",text:"Q"},{label:"C",text:"R"},{label:"D",text:"S"},{label:"E",text:"T"}],correctAnswer:"C",explanation:`First, determine how many baskets are needed in total.
Total balls = 10,890
Balls per basket = 6
...
15 \xF7 6 = 2 with a remainder of 3.
...
Thus, the correct answer is C.`},10:{id:"A6-q10",text:"The product of all positive integers from 1 to 250, inclusive, that are multiples of 7 is equal to k. If k can be expressed in the form $a*10^n$, where a and n are integers, what is the maximum possible value of n?",options:[{label:"A",text:"4"},{label:"B",text:"7"},{label:"C",text:"8"},{label:"D",text:"35"},{label:"E",text:"40"}],correctAnswer:"C",explanation:`The value of k is the product of {7, 14, 21, ..., 245}.
...
Thus, the correct answer is C.`},11:{id:"A6-q11",text:"Some of the people in Town X are left-handed, some are tall, some are both, and some are neither. In Town Y, three times as many people are left-handed as are left-handed in Town X, three times as many people are tall as are tall in Town X, three times as many people are both as are both in Town X, but no one is neither. If the total number of people in Town X is four times greater than the total number of people in Town Y, which of the following could be the number of people in Town X who are neither left-handed nor tall?",options:[{label:"A",text:"23"},{label:"B",text:"39"},{label:"C",text:"70"},{label:"D",text:"143"},{label:"E",text:"199"}],correctAnswer:"C",explanation:`Let L, T, B, N be the number of left-handed, tall, both, and neither people in Town X.
Total(X) = L + T - B + N.
...
Thus, the correct answer is C.`},12:{id:"A6-q12",text:"If there are 10 distinct points lying on the circumference of a circle, how many different triangles can be formed using these points as vertices?",options:[{label:"A",text:"30"},{label:"B",text:"90"},{label:"C",text:"120"},{label:"D",text:"240"},{label:"E",text:"720"}],correctAnswer:"C",explanation:`This is a combination problem. To form a triangle, we need to choose 3 distinct points from the available 10 points to serve as its vertices.
...
C(10, 3) = 10! / (3!(10-3)!)
C(10, 3) = 10! / (3!7!)
C(10, 3) = (10 \xD7 9 \xD7 8 \xD7 7!) / ((3 \xD7 2 \xD7 1) \xD7 7!)
C(10, 3) = (10 \xD7 9 \xD7 8) / (3 \xD7 2 \xD7 1)
C(10, 3) = 10 \xD7 3 \xD7 4 = 120
Therefore, 120 different triangles can be formed.

Thus, the correct answer is C.`}};export{a as EXAM_A6_QUESTIONS};
//# sourceMappingURL=A6-Y5UIAHI3.js.map
