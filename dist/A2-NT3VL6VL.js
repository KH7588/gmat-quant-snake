import{a as e}from"./chunk-JKPGA2EE.js";import"./chunk-FW4363Y4.js";var i={1:{id:"A2-q1",text:"If $x$ and $y$ are positive integers, is $x$ even?",statements:["\\$2x+y$ is odd","\\$5x+3y$ is odd"],options:e,correctAnswer:"C",explanation:`**Statement (1):** \\$2x + y$ is odd.
      ...
      **Combining Statement (1) and Statement (2):**
      ...
      Thus, the correct answer is C.`},2:{id:"A2-q2",text:"If $R(x)$ denotes the remainder when positive integer $x$ is divided by positive integer $k$, is $k > 10$?",statements:["$R(k+32)=8$","$R(k+42)=6$"],options:e,correctAnswer:"A",explanation:`R(x) denotes the remainder when $x$ is divided by $k$. This means $R(x) = x \\pmod k$.
      ...
      *   **Division (/):** \\$2^{4/2} = 4$; $(4/2)^2 = 4$. This works.
      ...
      Thus, the correct answer is A.`},4:{id:"A2-q4",text:"A person's new daily wage is \\$125\\%$ greater than his former daily wage. If he works \\$10\\%$ fewer hours per day, by what percentage does his new hourly wage exceed his former hourly wage?",options:[{label:"A",text:"125%"},{label:"B",text:"150%"},{label:"C",text:"175%"},{label:"D",text:"200%"},{label:"E",text:"225%"}],correctAnswer:"B",explanation:`Let $D_f$ and $H_f$ be the former daily wage and hours. Former hourly wage $W_f = D_f / H_f$.
      ...
      Thus, the correct answer is B.`},5:{id:"A2-q5",text:"What is the mean of three numbers $x, y,$ and $z$?",statements:["\\$2x-y+z=6$","$x+4y+2z=9$"],options:e,correctAnswer:"C",explanation:`We need to find the value of $(x+y+z)/3$. This requires finding the sum $x+y+z$.
      ...
      **Combining (1) and (2):**
      ...
      Thus, the correct answer is C.`},6:{id:"A2-q6",text:"An investment yields an annual interest rate of $a$ percent for the first year and $b$ percent for the second year. If the total return over the two-year period is the same as that of an investment that earns a constant annual rate of $x$ percent each year, express $x$ in terms of $a$ and $b$.",options:[{label:"A",text:"\\$100\\left(\\sqrt{\\left(1 + \\frac{a}{100}\\right)\\left(1 + \\frac{b}{100}\\right)} - 1\\right)$"},{label:"B",text:"$\\sqrt{ \\left( 1 + \\frac{a}{100} \\right) \\left( 1 + \\frac{b}{100} \\right) } - 1$"},{label:"C",text:"$\\frac{a+b}{2}$"},{label:"D",text:"\\$100\\left[\\left( 1 + \\frac{a}{100} \\right)\\left( 1 + \\frac{b}{100} \\right) - 1\\right]$"},{label:"E",text:"\\$100  \\frac{a+b}{200} $"}],correctAnswer:"A",explanation:`Let $P$ be the principal.
      ...
      Thus, the correct answer is A.`},7:{id:"A2-q7",text:"A product has a cost of \\$120. Its profit is 20 percent of its revenue. If the cost is reduced while the revenue remains unchanged, and the profit then becomes 30 percent of the revenue, what is the new cost of the product?",options:[{label:"A",text:"\\$90"},{label:"B",text:"\\$95"},{label:"C",text:"\\$100"},{label:"D",text:"\\$105"},{label:"E",text:"\\$110"}],correctAnswer:"D",explanation:`Let R be Revenue, C be Cost, and P be Profit. The fundamental relationship is Revenue = Cost + Profit.
...
Thus, the correct answer is D.`},8:{id:"A2-q8",text:"Pump A can empty a certain pool in 24 hours. After Pump A operates alone for 8 hours, the remaining water is pumped out by Pump B, whose pumping rate is 2/3 that of Pump A. How many additional hours are required for Pump B to empty the pool completely?",options:[{label:"A",text:"12"},{label:"B",text:"16"},{label:"C",text:"18"},{label:"D",text:"24"},{label:"E",text:"36"}],correctAnswer:"D",explanation:`Let the total work to empty the pool be 1 unit.
...
Thus, 24 additional hours are required for Pump B. The correct answer is D.`},9:{id:"A2-q9",text:"How many integers between 10 and 99, inclusive, are divisible by 3 or by 7\uFF1F",options:[{label:"A",text:"30"},{label:"B",text:"35"},{label:"C",text:"39"},{label:"D",text:"43"},{label:"E",text:"47"}],correctAnswer:"C",explanation:`We use the Principle of Inclusion-Exclusion: Total = (Divisible by 3) + (Divisible by 7) - (Divisible by both).
...
There are 39 such integers. The correct answer is C.`},10:{id:"A2-q10",text:"In a survey of voters concerning two candidates, A and B, 50 respondents support both candidates, and 100 respondents support neither candidate. What is the total number of respondents surveyed?",statements:["The number of respondents who support candidate A is equal to the number of respondents who do not support candidate A.","The ratio of respondents who support candidate B to those who do not support candidate B is 2:3."],options:e,correctAnswer:"C",explanation:`Let T be the total number of respondents.
...
Thus, the correct answer is C.`},11:{id:"A2-q11",text:"The six-digit integer 639,k70 is formed, where k represents a single digit from 0 to 9. Which of the following CANNOT be a divisor of this integer?",options:[{label:"A",text:"2"},{label:"B",text:"3"},{label:"C",text:"4"},{label:"D",text:"5"},{label:"E",text:"7"}],correctAnswer:"C",explanation:`Let the integer be N = 639,k70.
...
Therefore, 4 cannot be a divisor. The correct answer is C.`},12:{id:"A2-q12",text:"If n is an odd number, and the remainder when n is divided by 7 is 4. Which of the following could be divisible by 14?",options:[{label:"A",text:"n+3"},{label:"B",text:"n+5"},{label:"C",text:"n+7"},{label:"D",text:"n+9"},{label:"E",text:"n+11"}],correctAnswer:"A",explanation:`From the given information:
1.  n is odd.
...
//# sourceMappingURL=A2-NT3VL6VL.js.map
